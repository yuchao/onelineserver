...
cd && mkdir -p railsready-ruby193-rvm/src && cd railsready-ruby193-rvm && touch install.log
echo "done.."
...
"$PWD/rvm-install-head" >> ~/railsready-ruby193-rvm/install.log
...
rvm install 1.9.3 >> ~/railsready-ruby193-rvm/install.log
...
gem install bundler passenger rails --no-ri --no-rdoc >> ~/railsready-ruby193-rvm/install.log
echo "done..."
